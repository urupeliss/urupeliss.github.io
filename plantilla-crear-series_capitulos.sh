...
read nombrehtml
clear
echo 'Pon el nombre de la carpeta de la serie y pon _ remplazando el espacio'
read carpeta
mkdir $carpeta
cd $carpeta
echo '==============================================================='
echo 'Nombre de la serie que va en el titulo y arriba del reproductor'  
echo '==============================================================='
read titulo
clear
echo '========================================'
echo 'Temporada? *con el nombre de la carpeta*'
echo '========================================'
read temporada
mkdir $temporada
cd $temporada
clear
echo 'Numero de capitulo?'
read capitulo
